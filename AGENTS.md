...
- Upstream features may be fetched and merged, rebased, or cherry-picked into this branch. Resolve conflicts without dropping the chapter-comment protocol, source-scoped security boundary, or package id `io.legado.app.release` (debug: `io.legado.app.debug`).
